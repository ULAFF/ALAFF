function [ lambda1, v1 ] = PowerMethodLambda1( A, x, x0, maxits, illustrate, delay )
% Performs PowerMethod with vector x after subtracting out the component of
% x in the direction of x0
%
...
% Create initial vector by subtracting out the component of x in the
% direction of (unit length) vector x0 and normalizing the result
v1 = x - x0' * x * x0;
v1 = v1/ norm( v1 );
...
if illustrate ~= 0
    ReportConvergence( lambdas, "PowerMethodLambda1" );
end
